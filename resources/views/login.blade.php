...
<section class="p-10 bg-white rounded-lg max-w-md w-full">
    <h1 class="text-slate-900 text-3xl mb-10 font-medium">Login</h1>
    ...
    <form class=" grid grid-flow-row gap-4" action="login" method="POST">
        ...
        <button type="submit" class="bg-slate-900 text-white w-fit  px-6 py-2 rounded-lg text-sm">Login</button>
</form>
</section>
@endsection
